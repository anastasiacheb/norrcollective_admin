...
import { Package01Icon, MoreHorizontalCircle01Icon } from "@hugeicons/core-free-icons"
              ...
              <TableCell>
                <div className="flex items-center gap-3">
                  <div className="bg-muted rounded-sm flex size-9 shrink-0 items-center justify-center">
                    <HugeiconsIcon icon={Package01Icon} strokeWidth={2} className="text-muted-foreground size-4" aria-hidden="true" />
                  </div>
